...
def test_experimental_seam_analyzer_is_legacy_in_v34_root_registration():
    ...
    assert getattr(node_class, "DEPRECATED", False)
    assert node_class.CATEGORY == "MiniMax H3/Continuum/Legacy"
